// Package declaration to organize classes
...
//Define the class containing test methods
public class LoginPriority1 {
	...
	// TestNG test method with priority 1: This method runs first and sets up the browser
		@Test(priority=1)
		...
		// TestNG test method with priority 2: This method runs after setUp and performs login
		@Test(priority=2)
		public void verify()
		{
		...
		// TestNG test method with priority 3: This method logs out after login is done
		@Test(priority=3)
